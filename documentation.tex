...
The \textbf{Rates Risk Library} (\code{rates_risk}) is a comprehensive Python library designed for USD yield curve construction, fixed-income instrument pricing, and risk analytics. It provides a complete toolkit for trading desk workflows including:
...
\begin{lstlisting}
from rates_risk import DayCount, year_fraction
...
\begin{lstlisting}
from rates_risk import Conventions
...
\begin{lstlisting}
from rates_risk.dates import generate_bond_schedule, generate_swap_schedule
...
\begin{lstlisting}
from rates_risk import OISBootstrapper
from datetime import date
...
\begin{lstlisting}
from rates_risk import NelsonSiegelSvensson
from datetime import date
...
\begin{lstlisting}
from rates_risk import BondPricer, Conventions
...
\begin{lstlisting}
from rates_risk import SwapPricer
...
\begin{lstlisting}
from rates_risk import FuturesPricer
...
\begin{lstlisting}
from rates_risk.risk import BumpEngine
...
\begin{lstlisting}
from rates_risk.risk import KeyRateEngine, STANDARD_KEY_RATE_TENORS
...
\begin{lstlisting}
from rates_risk.var import HistoricalSimulation
import pandas as pd
...
\begin{lstlisting}
from rates_risk.var import MonteCarloVaR
...
\begin{lstlisting}
from rates_risk.var import ScenarioEngine, STANDARD_SCENARIOS
...
# Custom scenario
from rates_risk.var import Scenario
...
\begin{lstlisting}
from rates_risk import SabrSurfaceState, SabrBucketParams
...
\begin{lstlisting}
from rates_risk.portfolio import (
    build_bond_trade,
    build_swap_trade,
...
\begin{lstlisting}
from rates_risk.portfolio import price_portfolio_with_diagnostics
...
This chapter specifies the integration of the SABR stochastic volatility model into \code{rates_risk} for pricing vanilla rates options (caplets and swaptions) with smile-consistent risk management.
